...
if (isset($_POST['s_id']) && !empty($_POST['s_id'])) {
    ...
    if (isset($_POST['s_code']) && !empty($_POST['s_code']) 
        ...
        if ($s_id == '' || $s_id == null 
                || $s_code == '' || $s_code == null 
                || $s_name == '' || $s_code == null) {
            header("Location: ../index.php?page=staff/editsubject.php&controller=1&s_id=".$s_id."&error=Do not leave blank!");
            die();
        }
    ...
    header("Location: ../index.php?page=staff/index.php&error=Access denied!#subject");
    die();
}
?>